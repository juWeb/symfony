...
class TaskController extends Controller
{
    ...
    public function listTasks(TaskProvider $provider)
    {
        return /*new Response(
            $this->twig->render(
                'task/list.html.twig', 
            ...
            $this->render(
            'task/list.html.twig', 
            ['tasks' => $provider->provideTasks()]
             );
    }
    
    public function taskDetail(Request $request, TaskProvider $provider)
    {
